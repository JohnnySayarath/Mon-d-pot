...
namespace Demo01Classes.Classes
{
    internal class Dinosaur
    {
        ...
        // Propriétés (pour accéder et modifier les attributs, principe de l'encapsulation)
        public int Age
        {
            get => _age;
            set => _age = value;
        ...
        public Dinosaur(string nom, int age, string espece, bool peutVoler) // ici on a des paramètres d'entrées du constructeur
        {
            ...
            // _age = age; // utilisation de l'attribut (sans le passage par la proptiété)
            Age = age; // utilisation de la propriété et donc du setter
            Espece = espece;
            PeutVoler = peutVoler;
        }
