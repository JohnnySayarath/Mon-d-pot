...
namespace Demo02RelationsBlog.Migrations
{
    ...
    [Migration("20230822115003_ManyToMany")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Demo02RelationsBlog.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublishedOn = new DateTime(2023, 8, 22, 13, 50, 3, 9, DateTimeKind.Local).AddTicks(6919),
                            Title = "Coucou"
                        },
                        new
                        {
                            ...
                            PublishedOn = new DateTime(2023, 8, 22, 13, 50, 3, 9, DateTimeKind.Local).AddTicks(6959),
                        ...
                        new
                        {
                            ...
                            PublishedOn = new DateTime(2023, 8, 22, 13, 50, 3, 9, DateTimeKind.Local).AddTicks(6962),
            ...
            modelBuilder.Entity("BlogTag", b =>
                {
                    b.HasOne("Demo02RelationsBlog.Models.Blog", null)
                        .WithMany()
                        .HasForeignKey("BlogsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Demo02RelationsBlog.Models.Tag", null)
                        .WithMany()
